...
<jsp:useBean id="team" class="com.app.beans.TeamBean" scope="session" />
<body>
		...
		<table style="background-color: lightgrey; margin: auto">
			<tr>
				...
				<td><select name="myTeam">
						<c:forEach var="p"
							items="${team.getAllTeamIdAbbrevation()}">
							<%-- items="${sesssion.getAttributes("team").getAllTeamIdAbbrevation()}"> --%>
							<option value="${p.id}">${p.abbrevation}</option>
						</c:forEach>
				</select></td>
			</tr>
			<tr>
